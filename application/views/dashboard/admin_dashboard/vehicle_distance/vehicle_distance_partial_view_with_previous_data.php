...
<table id="TripReportData" class="table table-bordered table-striped dataTables" style="border-collapse: collapse !important;">
            ...
            value="" readonly>
              ...
              <input class="<?php echo $startinput?> startKM" type="text" name="start_km[]" id="start_km_<?php echo $row;?>" onKeyUp="numericFilter(this);" autocomplete="off" value="<?php echo $value['lastDistance'];?>" <?php echo $startinput?> ></td>

              <td class="<?php echo $hidecolumn;?>">
                <input class="endKM" type="text" name="end_km[]" id="end_km_<?php echo $row;?>" onKeyUp="numericFilter(this);" autocomplete="off" value="<?php if($mode=="EDIT"){echo $value->end_km;}else{echo '';}?>"></td>
               <td class="<?php echo $hidecolumn;?>">
