  ...
  color: #FFF !important;
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Quantity Report</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <form action="#" name="QuantityReportForm" id="QuantityReportForm">
              ...
              <div class="row" style="margin-bottom: 0;">
                    ...
                    <div class="form-group">
                        <button type="button" id="quantityTripReportBtn" class="btn bg-navy btn-flat margin" style="margin-left:10px;margin-top:5px;border-radius: 96px !important;background:#09749f !important;"> <i class="fa fa-eye"></i> View </button>
                    </div>
