  ...
  color: #FFF !important;
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Excavator Report</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Excavator Wise Trip Report</h3>&nbsp;
             
            </div>
            <!-- /.box-header -->

            <form action="#" name="ExcavatorWiseReport" id="ExcavatorWiseReport">
              ...
              <div class="row" style="margin-bottom: 0;">
                    ...
                    <div class="form-group">
                        <button type="button" id="excavatorReportBtn" class="btn bg-navy btn-flat margin" style="margin-left:30px;margin-top:5px;border-radius: 5px !important;background:#09749f !important;"> <i class="fa fa-eye"></i> View </button>
                    </div>
                    <p id="error_msg" class="form_error"></p>
                  </div> <!-- /.col-md-4 END -->
