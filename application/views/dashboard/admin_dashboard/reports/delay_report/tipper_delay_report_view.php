  ...
  background-color: #f2e8dc;
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tipper Delay Report</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Tipper Delay Report</h3>&nbsp;
             
            </div>
            <!-- /.box-header -->

            <form action="#" name="tipperDelayReport" id="tipperDelayReport">
                  ...
                  <div class="row" style="margin: 2% auto;margin-bottom: 0;">
                    ...
                    <div class="form-group">
                        <button type="button" id="tipperDelayReportBtn" class="btn bg-navy btn-flat margin" style="margin-left:30px;margin-top:5px;border-radius: 5px !important;background:#09749f !important;"> <i class="fa fa-eye"></i> View </button>
                    </div>
                    <p id="error_msg" class="form_error"></p>
                  </div> <!-- /.col-md-4 END -->
