   ...
   <section class="content-header">
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Operator Performance Report (Excavator)</h3>&nbsp;
             
            </div>
            <!-- /.box-header -->

            <form action="#" name="ExcaOperatorReport" id="ExcaOperatorReport">
              ...
              <div class="row" style="margin-bottom: 0;">
                    ...
                    <div class="form-group">
                        <button type="button" id="excaOperatorReportBtn" class="btn bg-navy btn-flat margin" style="margin-left:30px;margin-top:5px;border-radius: 5px !important;background:#09749f !important;"> <i class="fa fa-eye"></i> View </button>
                    </div>
                    <p id="error_msg" class="form_error"></p>
                  </div> <!-- /.col-md-4 END -->
