...
<html lang="en">
<head>
<title>Logistic Admin Login </title>
<meta charset="utf-8">
...
.banner-sec{background:url(<?php echo base_url();?>assets/images/tippertruck.jpg)  no-repeat left bottom; background-size:cover; min-height:500px; border-radius: 0 10px 10px 0; padding:0;}
